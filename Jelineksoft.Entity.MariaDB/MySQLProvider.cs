...
namespace Jelineksoft.Entity.Providers
{
    ...
    public class MySQLProvider : Jelineksoft.Entity.ProviderBase
    {
        ...
        public MySQLProvider(int timeout)
        {
        ...
        public MySQLProvider(String connectionString, int timeout)
        {
            this.ConnectionString = connectionString;
            this.CommandTimeout = timeout;
            ResetProvider();
        ...
        private MySql.Data.MySqlClient.MySqlCommand _command = null;
        ...
        public override IDbConnection Connect()
        {
            ...
            {
                this._connection = new MySql.Data.MySqlClient.MySqlConnection(this.ConnectionString);
            }
        ...
        private void CreateCommand()
        {
            if (this._command == null)
            {
                this._command = new MySql.Data.MySqlClient.MySqlCommand();
            }
        ...
        {
            return new MySQLProvider(this.ConnectionString, this.CommandTimeout);
        }
        ...
        public override void AddWhereParameter(String _columnName, String _tableName, Object _value, PropertyCompareOperatorEnum _propertyCompare, WhereMergeOperatorEnum _whereMergeOperator)
        {
            ...
            else
            {
                ...
                {
                    this._sb_where.Append(_where_addParenthesisStart + "`"+  _tableName + "`.`" + _columnName + "` IS NULL");
                }
                if (_propertyCompare == PropertyCompareOperatorEnum.IsNotEqual)
                {
                    this._sb_where.Append( _where_addParenthesisStart +"`"+  _tableName +"`.`" + _columnName + "` IS NOT NULL");
                }
            }
            this._where_addParenthesisStart = String.Empty;
        }
        ...
        public override System.Data.IDataReader CreateSqlSelect()
        {
            ...
            sql.Append("SELECT " + _sb_distinct);
        ...
        public override void AddColumnToUpdate(string _name, object value)
        {
            ...
            if (value != null)
            {
                ...
                */
                    var par = new MySqlParameter(paramName, MySqlDbType.Timestamp);
                    par.Value = value;
                    _command.Parameters.Add(par);
        ...
        */
        ...
        {
            this._limit = " LIMIT " + count.ToString() + " ";
        }
        ...
        public override object ReaderReturnNetType(object value)
        {
            ...
            {
                return ((MySqlDecimal)value).Value;
            }
